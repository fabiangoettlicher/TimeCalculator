...
#-keep class com.fagoett.timecalc.** { *; }
#-dontwarn com.fagoett.timecalc.**

# Keep component classes and inject methods
-keep class com.fagoett.timecalc.injection.components.** {
    public void inject(...);
}

# Keep model classes
-keep class com.fagoett.timecalc.data.model.** { *; }
